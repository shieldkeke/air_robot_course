...
/*colvec R_to_ypr(const mat& R)
{
  ...
  colvec ypr(3);
std::cout << "R2ypr 1" << std::endl;
  double y = atan2(n(1), n(0));
std::cout << "R2ypr 2" << std::endl;
...
{
  std::cout << "q2R 1" << &q << std::endl;
  //double n = norm(q, 2);
  std::cout << "cols" << q.n_cols << "rows" << q.n_rows << std::endl;
  //std::cout << " q(0) " << q(0) << " q(1) " << q(1) << " q(2) " << q(2) << " q(3) " << q(3) <<std::endl;
  double n = 1;
  //double n = sqrt(q(0) * q(0) + q(1) * q(1) + q(2) * q(2) + q(3) * q(3));
  //colvec nq = q / n;
  //colvec nq = q;
  //std::cout << "q2R 2" << std::endl;
